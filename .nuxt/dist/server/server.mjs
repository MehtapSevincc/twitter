var _a;
import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent as defineComponent$1, createElementBlock, provide, cloneVNode, h, watch, onScopeDispose, watchEffect, capitalize, unref, Fragment, camelize, isVNode, Comment, warn, ref, computed, toRefs, createVNode, mergeProps, createElementVNode, normalizeClass, toValue, readonly, useId, normalizeStyle, TransitionGroup, Transition, nextTick, withDirectives, vShow, Text, resolveDynamicComponent, toDisplayString, markRaw, Teleport, createTextVNode, normalizeProps, guardReactiveProps, withModifiers, vModelText, resolveComponent, render, Suspense, withCtx, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/mehta/Desktop/twitter/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/mehta/Desktop/twitter/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/Users/mehta/Desktop/twitter/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia } from "pinia";
import { defu } from "C:/Users/mehta/Desktop/twitter/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "C:/Users/mehta/Desktop/twitter/node_modules/radix3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "C:/Users/mehta/Desktop/twitter/node_modules/ufo/dist/index.mjs";
import "C:/Users/mehta/Desktop/twitter/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-xLm4ugjv.js")
  }
];
...
function removeListeners(el) {
  ...
  if ((_a2 = el._ripple) == null ? void 0 : _a2.keyDownHandler) {
    ...
    return () => {
      ...
      return ((_a2 = slots.default) == null ? void 0 : _a2.call(slots)) ?? ((_b = props.items) == null ? void 0 : _b.map((item, index, items) => {
        ...
        const slotsWithItem = {
          prepend: (slotProps) => {
            var _a4;
            return createElementVNode(Fragment, null, [props.selectable && (!children || children && !["leaf", "single-leaf"].includes(props.selectStrategy)) && createElementVNode("div", null, [createVNode(VCheckboxBtn, {
              "key": item.value,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BfCwvKmt.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DpYV5_I5.js"));
